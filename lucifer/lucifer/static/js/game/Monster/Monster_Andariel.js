...
Andariel = function(game, x, y, Hp, MaxHp, CognizeRange, AttackRange)
{
	...
	//Stat
	this.Attack_Point = 240, this.Defence_Point = 70;
	...
	//Level System
	this.ExpCheck = false, this.ExpTimer, this.ExpTime_Total = 0, this.Experience = 200;
...
{
	andariel_Object = new Andariel(Lucifer_Game, PointX, PointY, 2500, 2500, 230, 100);
