...
//UI
//----------------------------------------------------------------------------------------------
function wraith_Health(health, maxHealth)
{
...
function wraith_Health_Rate(health_Percentage)
{
	var hpRate;
...
{
	var healthPercentage = wraith_Health(Object.Hp, Object.MaxHp);
	var hpRate = wraith_Health_Rate(healthPercentage);
